...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/title.jpg"))); // NOI18N
        jLabel9.setText("jLabel8");

        jLabel10.setFont(new java.awt.Font("Showcard Gothic", 1, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/icon.jpg"))); // NOI18N
    ...
    try (Connection con = DatabaseConnector.getConnection();
        ...
        if (rs.next()) {
            ...
            //Send email
            Email.sendEmail(otp, email);
                       
            
            VerifyCode vFrame = new VerifyCode(fullname, email, password, otp);
